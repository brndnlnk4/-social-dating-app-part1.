<form action="<?=$_SERVER['DOCUMENT_ROOT'].'/m8tom8/prof/?'.md5('reg')?>" method='POST' class='form form-inline'>
  ...
  <div class='table step1 '>
	...
	<div class=' step2 collapse'>
	 <span class='center-block text-center' style='max-width:90%;'>
	  <strong class=' well-sm'>Create Username and Password</strong>
	 </span>
	 <br>
		 ...
		 <td colspan='100%'>
		  <center style='border-top:1px dotted #888;'>
		   ...
		   <center style='display:block;width:300px;margin:0 auto;padding:5px 5px;background-color:rgba(0,0,0,0.35);border-radius:20px;'>
		    <img src='/m8tom8/css/img/ren2.jpg' alt='AntiBot' title='Anti-Bot Question' width='' class='img-responsive img-rounded' />
	     </center>
		</td>	
	   </tr>
	   <tr>
